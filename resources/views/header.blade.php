	<div id="header">
			...
			<div class="container">
				<div class="pull-left auto-width-left">
					<ul class="top-menu menu-beta l-inline">
						<li><a href=""><i class="fa fa-home"></i> Nhóm 38</a></li>
						<li><a href=""><i class="fa fa-phone"></i> 0382698208</a></li>
					</ul>
				</div>
		...
		<div class="header-body">
			<div class="container beta-relative">
				<div class="pull-left">
					<a href="index.html" id="logo"><img src="SOURCE/assets/dest/images/LOGO11.png" width="200px" alt=""></a>
				</div>
